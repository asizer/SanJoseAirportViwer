define(function() {
    ...
    return {
        layout: {
            ...
            headerTitle: 'Naperville Campus PlaceFinder'
        },
        mapSetup: {
        ...
        basemapGallery: {
            ...
            customBasemaps: [{
                ...
                'baseMapLayers': [{
                    ...
                    url: 'http://tryitlive.arcgis.com/arcgis/rest/services/Campus/MapServer'
                }]
            }]
        },
        dataLayer: {
            mapServiceUrl: 'http://tryitlive.arcgis.com/arcgis/rest/services/BuildingInterior/MapServer/',
            legendTitle: 'Naperville Campus',
